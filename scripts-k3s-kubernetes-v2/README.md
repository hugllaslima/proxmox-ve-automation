...
> Devido ao [anúncio de fim de suporte](https://kubernetes.github.io/ingress-nginx/) do projeto comunitário **'Ingress NGINX'** em 11 de novembro de 2025, esta versão do projeto original migrou para o uso nativo do **'Traefik'** em conjunto com a moderna **'Gateway API'**.
